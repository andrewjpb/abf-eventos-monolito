        ...
        {featuredEvent && (
          <Suspense fallback={<div className="flex justify-center p-0"><Spinner /></div>}>
            <div className="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
              <div className="sm:grid sm:grid-cols-12 sm:gap-4 md:gap-5 lg:gap-6">
                ...
                <div className="sm:col-span-5 md:col-span-4 lg:col-span-4 xl:col-span-4 h-auto sm:h-full min-h-[180px] sm:min-h-0">
                  <Suspense fallback={
                    <div className="flex justify-center items-center h-full min-h-[180px] rounded-lg bg-card/50">
                      <Spinner />
                    </div>
                  }>
                    <BannersSidebar
